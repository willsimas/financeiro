...
const twentyFivePercentDisplay = document.querySelector('#money-minus')
...
const updateBalanceValues = () => {
  ...
  const twentyFivePercent = (total * 0.25).toFixed(2);
  ...
  twentyFivePercentDisplay.textContent = `R$ ${twentyFivePercent}`;
}
